...
public struct BodyTextSyle<S: ShapeStyle>: TextStyleModifier {
...
public extension View {
    func bodyTextStyle(color: AppPlatformShapeStyle<Color> = .default) -> some View {
        modifier(BodyTextSyle(foregroundStyle: color))
    }
}
